...
The bitmap font textures and glyph data processed by this tool are the
copyrighted property of **Mojang AB** (a Microsoft subsidiary). These assets
are extracted at runtime from the official Minecraft client JAR and are
...
When unifont fallback is enabled, this tool downloads [GNU Unifont](https://unifoundry.com/unifont/)
hex files from Minecraft's asset index at runtime. GNU Unifont is licensed under
the **GNU General Public License v2+** with a font embedding exception that
