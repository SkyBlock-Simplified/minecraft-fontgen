...
def create_font_header_table(font, use_cff: bool = True):
    ...
    head.flags = 0x03 # Bit flags that define font-wide behavior (e.g., baseline, left sidebearing point at x=0)
    head.fontRevision = 0x00005000 if use_cff else 0x00010000
    ...
    head.tableVersion = 0x00005000 if use_cff else 0x00010000
